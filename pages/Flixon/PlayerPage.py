...
class PlayerPage(object):
    ...
    def initial_check_of_player_page_recorded_event(self):
        ...
        self.back_10_sec_button.should(be.visible).should(be.clickable)
        self.back_button.should(be.visible).should(be.clickable)
        self.forward_button.should(be.visible).should(be.clickable)
        self.forward_30_sec_button.should(be.visible).should(be.clickable)
        self.playstop_stop_button.should(be.visible).should(be.clickable)
        self.cc_menu_button.should(be.visible).should(be.clickable)
